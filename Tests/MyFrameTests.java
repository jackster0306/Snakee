...
public class MyFrameTests {
    ...
    @Nested
    class MySnakeClass{
        example.MyFrame.MySnake snake;
        @BeforeEach
        public void init(){
            snake = new MyFrame.MySnake(100,100);
        }
        ...
        class OutOfBoundsMethod{
            ...
            @Test
            void XOutOfBounds(){
                snake = new MyFrame.MySnake(-5,100);
                snake.testOOB();
                assertEquals(false, snake.l);
                snake = new MyFrame.MySnake(880, 100);
                snake.testOOB();
                assertEquals(false, snake.l);
            }
            ...
            @Test
            void YOutOfBounds(){
                snake = new MyFrame.MySnake(100,30);
                snake.testOOB();
                assertEquals(false, snake.l);
                snake = new MyFrame.MySnake(100, 570);
                snake.testOOB();
                assertEquals(false, snake.l);
            }
        }
